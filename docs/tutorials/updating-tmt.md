...
This tutorial assumes that 你有 used [the Getting Started Tutorial](getting-started.md), and are using Github Desktop and VSCode for your mod.

Here's what 你有 to do when there's a TMT update:
...
4. Select upstream/master. It will likely say there are conflicts, but 你有 tools to resolve them. Click "Merge upstream/master into master".
